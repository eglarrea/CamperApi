 ...
 *
 * <p>Esta clase encapsula la lógica de acceso a datos de usuarios y
 * transforma las entidades de la base de datos en objetos DTO
 * que pueden ser devueltos al cliente.</p>
 *
 ...
 *   <li>Convertir la entidad {@link Usuario} en un objeto {@link UserDtoResponse}.</li>
 * </ul>
 *
 * <p>Las excepciones se gestionan con mensajes internacionalizados
 * mediante {@link MessageSource} y {@link LocaleContextHolder}.</p>
 */
@Service
public class UserService {
     ...
     *   <li>Si no existe, lanza {@link UsernameNotFoundException} con mensaje traducido.</li>
     ...
     *   <li>Si no existe, lanza {@link ResponseStatusException} con mensaje traducido.</li>
     ...
     * @throws IllegalArgumentException si la confirmación de contraseña no coincide.
     */
    public UserDtoResponse updateUserData(String email, RegisterRequest updatedData) {
        ...
        if (updatedData.getPassPersona() != null && !updatedData.getPassPersona().isBlank()
            ...
            if (!updatedData.getPassPersona().equals(updatedData.getConfirmPassPersona())) {
                String mensaje = messageSource.getMessage("user.password.confirm", null, LocaleContextHolder.getLocale());
        ...
        if (updatedData.getNombrePersona() != null && !updatedData.getNombrePersona().equals(usuario.getNombre_persona())) {
        ...
        return new UserDtoResponse(
                usua.getId(),
                usua.getNombre_persona(),
                usua.getApellidos_persona(),
                usua.getFec_nacimiento_persona(),
                usua.getDni_persona(),
                usua.getIban_persona(),
                usua.getEmailPersona(),
                usua.is_admin(),
